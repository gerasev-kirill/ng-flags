(function() {
  module.exports = function(grunt) {
          ...
          replacements: [
            {
              from: '@@CSS_16',
              to: function() {
                return grunt.file.read('dist/css/flags16.min.css');
              }
            }, {
              from: '@@CSS_32',
              to: function() {
                return grunt.file.read('dist/css/flags32.min.css');
              }
            }
          ]
        }
    ...
    return grunt.registerTask('dist-uglify', ['coffee:compileJoined', 'imagemin:flags', 'cssmin:flags', 'dataUri:flags', 'replace:flags', 'uglify:uiFlag']);
  };
